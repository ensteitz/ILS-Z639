...
reddit = praw.Reddit(client_id="9eaZgAHFqJAkFbK6fFJAMg",
        ...
        password="password",
        user_agent="Project to analyze public sentiment surrounding racial diversity in AI, username=fallenfloral")
...
submission = reddit.submission("1awis1r")
...
attributes_df["timestamp"] = attributes_df["created"].apply(get_date)
...
attributes_df.to_csv('df_comments.csv', index=False)
